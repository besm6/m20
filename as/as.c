 ...
 */
{ 000, L"зп"	}, /* Пересылка */
{ 020, L"счп"	}, /* Чтение пультовых тумблеров */
...
{ 050, L"ма"	}, /* Подготовка обращения к внешнему устройству */
{ 070, L"мб"	}, /* Выполнение обращения к внешнему устройству */
...
{ 052, L"раа"	}, /* Установка регистра адреса */
{ 072, L"ра"	}, /* Установка регистра адреса по числу */
